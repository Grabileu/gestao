export default function CashBreakTable({ data, isLoading, onEdit, onDelete }) {
  if (isLoading) {
      ...
      <table className="w-full border-collapse border border-gray-300">
        <thead>
          <tr className="bg-gray-100">
            ...
            <th className="border border-gray-300 p-3 text-left">Loja</th>
        ...
        <tbody>
          {data.map((item) => (
            <tr key={item.id} className="hover:bg-gray-50">
              ...
              <td className="border border-gray-300 p-3">{item.store}</td>
              <td className="border border-gray-300 p-3">{item.date}</td>
              <td className="border border-gray-300 p-3">{item.duration} min</td>
