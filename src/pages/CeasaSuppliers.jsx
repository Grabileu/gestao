      ...
      <Dialog open={showForm} onOpenChange={() => { setShowForm(false); setEditingSupplier(null); }}>
        <DialogContent className="bg-slate-900 border-slate-700">
          <DialogHeader>
            ...
            <DialogDescription className="sr-only">Formulário para {editingSupplier ? "editar" : "criar"} fornecedor</DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={!!showProducts} onOpenChange={() => setShowProducts(null)}>
        <DialogContent className="max-w-2xl bg-slate-900 border-slate-700">
          <DialogHeader>
            ...
            <DialogDescription className="sr-only">Lista de produtos do fornecedor {showProducts?.name}</DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={showProductForm} onOpenChange={() => { setShowProductForm(false); setEditingProduct(null); }}>
        <DialogContent className="bg-slate-900 border-slate-700">
          <DialogHeader>
            ...
            <DialogDescription className="sr-only">Formulário para {editingProduct ? "editar" : "criar"} produto</DialogDescription>
          </DialogHeader>
